# -*- coding: utf-8 -*-
"""
paper117_path_order_validation.py
...
def run_3segment_magnus_diagnostic(
    ...
    diagnostic = {
        ...
        "interpretation_boundary": (
            ...
            "comparisons such as permutation 2 versus 3. Exact reversal-pair "
            "scaling and variable partitions are outside this paper-only "
            "script. TVD is the primary population-level discriminator; D is "
            "secondary. Rough 1/TVD^2 values are scale indicators, not "
...
def main():
    print(
        "\n"
        + "=" * 88
        + "\nPAPER117 NEUTRAL-ATOM PULSE-ORDER VALIDATION"
        + "\n"
        + "=" * 88
    )
    print("output:", OUTDIR)
    ...
    _, cv_cert = run_cross_validation()
    (
        scan_df,
        _,
        _,
    ...
    summary = {
        "status": status,
        "paper_scope": (
            "Fixed-T 117-point two-proxy comparison and a six-permutation "
            "equal-A2 diagnostic. No N=2 shared-generator or variable-"
            "partition claim is included."
        ),
        "primary_backend": "scipy_expm",
        ...
        "zero_gap_numerical_floor": scan_cert[
            "zero_gap_numerical_floor"
        ],

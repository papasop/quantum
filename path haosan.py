...
# -*- coding: utf-8 -*-
"""
M2 FOUR-STEP PATH-RESOLVED NOISE CLOSURE  (M2-P4-v1.2)
...
Colab / Jupyter:
    ...
    !python m2_four_step_path_noise_closure_v1_2.py
...
def save_latex_macros(path: Path, result: dict[str, Any]) -> None:
    ...
    lines = [
        "% Auto-generated by m2_four_step_path_noise_closure_v1_3.py",
